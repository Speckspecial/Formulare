...
\newcommand{\member}[3]{
    \internalmember{#1}{#2}{#3}{216}{1320} % age <= 1320 month (= 120 years)
}

\newcommand{\memberchild}[3]{
    \internalmember{#1}{#2}{#3}{0}{216} % age <= month (= 18 years)
}
