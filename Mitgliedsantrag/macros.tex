\input{formhelper.tex}

\newcommand{\internalpersonneutral}[3]{
...
\makecell[cl]{\DateField{txtGeburtsdatum#2}{-#3}{0}}
\end{tabular}
}

\newcommand{\personneutral}[2]{
    \internalpersonneutral{#1}{#2}{1320}
}

\newcommand{\internalperson}[3]{
\internalpersonneutral{#1}{#2}{#3}
\\[2ex]
...
\newcommand{\member}[3]{
    \internalmember{#1}{#2}{#3}{1320} % age <= 1320 month (= 120 years)
}

\newcommand{\memberchild}[3]{
    \internalmember{#1}{#2}{#3}{216} % age <= month (= 18 years)
}
